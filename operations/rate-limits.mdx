...
| Plan | Checks per hour | Saved URLs | Projects | Audit pages | Audits per month |
| :--- | ---: | ---: | ---: | ---: | ---: |
| Anonymous | 50 | — | — | — | — |
| Free | 100 | 3 | 1 | 25 | 1 |
| Pro | 1,000 | unlimited | unlimited | 500 | 50 |

[Site audits](/guides/site-audits) are metered separately from the hourly check
quota. One 500-page audit would otherwise consume half a Pro account's hour, and

...
| Plan | Checks per hour | Saved URLs | Projects | Audit pages | Audits per month | Monitors | Sharing | PDF | API keys |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Anonymous | 50 | — | — | — | — | — | — | — | — |
| Free | 100 | 3 | 1 | 25 | 1 | — | summary | — | 1 |
| Pro | 1,000 | unlimited | unlimited | 500 | 50 | 3 | full | yes | 10 |
